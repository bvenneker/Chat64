...
.word    main_init                                // Cartridge warm-start vector dynamic
...
!wifi_setup:                                      // 
    ...
    jmp !novice+                                  // if so jump to no-vice                                                   
!:                                                //
...
shiftError:                   .byte 143,146; .text"system: Error: shift error";.byte 128
