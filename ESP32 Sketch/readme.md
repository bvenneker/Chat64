...
1) Download the zip file from this folder and extract it. You now should have a folder called: C64_Chat_3_79 with all file files in it.

<img src="/Artwork/updt1.png" width="300">
 
2) Open C64_Chat_3_79.ino in Arduino IDE. You should see that the other files have been opened automatically.
